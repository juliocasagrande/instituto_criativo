...
export default function Login() {
  ...
  async function handleLogin(e) {
    ...
    try {
      ...
      if (user.tipo === 'profissional') navigate('/profissional')
      else if (user.tipo === 'admin') navigate('/admin')
      else navigate('/responsavel')
    } catch (err) {
        ...
        {aba === 'login' && (
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              ...
              <input type="password" required value={loginForm.senha}
        ...
        {aba === 'cadastro' && (
          <form onSubmit={handleCadastro} className="space-y-4">
            <div>
              ...
              <input type="text" required value={cadastroForm.nome}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Senha</label>
              <input type="password" required value={cadastroForm.senha}
            ...
            <div>
              ...
              <select value={cadastroForm.tipo}
